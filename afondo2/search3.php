        ...
        <div class="busqueda">
            <h2>Resultado de la busqueda: <b><?php echo get_search_query(); ?></b></h2>
             ...
             <?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
                <div class="caja busqueda__item">
                    <div class="caja busqueda__item__foto">
                            <?php
                    ...
                    <div class="caja busqueda__item__textos">
                            <div class="busqueda__item__textos__titulo">
                            ...
                            <div class="busqueda__item__textos__resumen__fecha">
                                    Por <?php the_author_posts_link(); ?> / 
                                    <?php echo the_date('l, F j, Y'); ?> /
                                    en <?php the_category(', '); ?>
                                </div>

                            <div class="busqueda__item__textos__resumen">
                                    <?php echo get_the_excerpt($ID); ?>
                                </div>

                            <!-- <div class="busqueda__item__textos__leermas">
                                <a href="<?php echo the_permalink(); ?>">
                                        Leer más >
                                    </a>
                            </div> -->
