                ...
                <?php if ($item == 1) { ?>
                    ...
                    <div class="caja categoria__categorias__item">
                            <div class="categoria__categorias__item__foto">
                                    <?php
                                    $image_th = wp_get_attachment_image_src( get_post_thumbnail_id(), 'slider' );
                                    ?>  
                                    <a href="<?php echo the_permalink(); ?>" class="imagen-enlace">
                    ...
                    <?php if (($item > 1) && ($item < 14 )) { ?>
                        

                        <div class="caja base-100 tablet-50 categoria__categorias__item" style="height: 480px;">
                            ...
                            <div class="caja categoria__categorias__item__textos">
                                    <div class="categoria__categorias__item__textos__titulo">
                                            <a href="<?php echo the_permalink(); ?>"  style="font-size: 25px;">
                                                <?php echo get_the_title($ID); ?>
                                            </a>
                                        </div>
