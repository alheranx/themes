...
<header>
    ...
    <div class="anuncio720__wrapper">
        ...
        <div class="grupo hasta-web">
            <div data-glade data-ad-unit-path="/44924376/afondoedomex_300x250" height="250" width="300"></div>

            <script async='async' src='https://securepubads.g.doubleclick.net/static/glade.js'></script>
        </div>

        <div class="grupo desde-web anuncio720">
            <div class="caja base-12 anuncio720">
                <div class="anuncio720__anuncio">
                    <script async src='//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js'></script>
                    <!-- Primera página - 1 (afondoedomex.com) -->
                    <ins class='adsbygoogle' style='display:block;background:none!important;' data-ad-client='ca-pub-5933170404538438' data-ad-slot='2298315508' data-ad-format='auto'></ins><script>(adsbygoogle = window.adsbygoogle || []).push({});</script>
                </div>
            </div>
        </div>
        <?php } ?>
